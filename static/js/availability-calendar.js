(function ($) {
	...
	AvailabilityCalendar.prototype = {
		...
		__createToolbar: function () {
			...
			$inputContainer.append('<input type="button" class="btn btn-primary" title="This month" value="This Month">');
			$inputContainer.append('<input type="button" class="btn btn-primary" title="Previous month" value="&#10094;">');
			$inputContainer.append('<input type="button" class="btn btn-primary" title="Next month" value="&#10095;">');
